...
#define STRING_CONFIG_H_AUTHOR "(rfield19, Ender-3v2)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  45.35
    #define DEFAULT_Ki   7.07
    #define DEFAULT_Kd 72.72
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Creality Ender-3 Pro
  #define DEFAULT_bedKp 120.87
  #define DEFAULT_bedKi 23.19
  #define DEFAULT_bedKd 419.93
...
#define PREHEAT_3_TEMP_HOTEND 232
